...
echo
	...
	markhorVersion='0.2 alpha'

	isoLabel='Markhorlinux-'$markhorVersion'-x86_64.iso'

	# setting of the general parameters
	archisoRequiredVersion="archiso 58-1"
	buildFolder="/home/manzoor/Documents/iso/Markhor-build"
	outFolder="/home/manzoor/Documents/iso/Markhor-Out"
	archisoVersion=$(sudo pacman -Q archiso)

	echo "################################################################## "
	echo "Building the desktop                   : "$desktop
	echo "Building version                       : "$markhorVersion
...
echo
	...
	#profiledef.sh
	oldname1='iso_name="markhorlinux'
	newname1='iso_name="markhorlinux'

	oldname2='iso_label="markhorlinux'
	newname2='iso_label="markhorlinux'

	oldname3='markhorlinux'
	newname3='markhorlinux'

	#hostname
	oldname4='markhorlinux'
	newname4='markhorlinux'

	#sddm.conf user-session
	oldname5='Session=gdm'
	...
	sed -i 's/'$oldname5'/'$newname5'/g' $buildFolder/archiso/airootfs/etc/gdm.conf
